...
//    for (int i = 0; i < 12; i++) {
//        NSLog(@"On the %@ Day of Christmas my true love gave to me: %@" , daysOfChristmas[i], thingsMyTrueLoveGaveToMe[i]);
//        NSLog(@"%@", lotsOfGifts);
//        if (i == 0) {
//            lotsOfGifts = [lotsOfGifts stringByAppendingString:thingsMyTrueLoveGaveToMe[i]];
//        } else {
